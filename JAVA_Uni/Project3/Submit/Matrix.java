...
public abstract class Matrix {
    ...
    public String toString() {
        ...
        // Loops through rows and colums to create a string of the matrix
        for(int i=0;i<this.m;i++){
            StringMatrix = StringMatrix + " " + String.format("%.4f",getIJ(i,0));
        
            for(int j=1;j<this.n;j++){
                StringMatrix = StringMatrix + " " + String.format("%.4f",getIJ(i,j));
            }
